   ...
   function Menu(w, tata){
    ...
    if(NS){
     aux.clip.bottom=2;
     aux.clip.right=w;
     txt = "<table border=0 cellspacing=0 cellpadding=0 width=100% height=100% class=item><tr><td class=item colspan=2 bgcolor="+parentWindow.menuFgColor+" height=1><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td bgcolor="+parentWindow.menuFgColor+" height=100% width=1 class=item><img src=/ccrc/images/nimic.gif width=1></td><td bgcolor="+parentWindow.menuBgColor+" width=100% height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td colspan=2 bgcolor="+parentWindow.menuBgColor+" height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr></table>";
    } else {
     aux.style.width=w;
     txt = "<table border=0 cellspacing=0 cellpadding=0 bgcolor='"+parentWindow.menuFgColor+"' id=tablou width="+w+" class=item><tr><td colspan=3 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td width=1 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td><td colspan=2 bgcolor="+parentWindow.menuBgColor+" height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr></table>";
    }
    scrie(aux, txt);
   ...
   function MenuItem(text, tata, exe){
    ...
    if(NS){
     ...
     cel.innerHTML = "<img src=/ccrc/images/nimic.gif width=1 height=1>";
     cel.style.width="1";
     cel.style.height="1";
   ...
   function MenuSeparator(tata, x, ceFel){
    if(NS){
     ...
     aux.moveTo(1, tata.clip.bottom - 1);
     if(ceFel==1){
     	scrie(aux, "<table border=0 cellspacing=0 cellpadding=0 width=100% class=item><tr><td bgcolor="+parentWindow.menuBgColor+" width=1 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td bgcolor="+parentWindow.menuFgColor+" width=1 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr></table>");
     }else{
     	scrie(aux, "<table border=0 cellspacing=0 cellpadding=0 width=100% class=item><tr><td bgcolor="+parentWindow.itemOffColor+" width=1 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td bgcolor="+parentWindow.itemOffColor+" width=1 height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr></table>");
     }
     tata.clip.bottom += aux.clip.bottom;
     return aux;
    }
     ...
     var cel = tr.insertCell(0);
     cel.innerHTML = "<img src=/ccrc/images/nimic.gif height=1 width=1>";
     cel.style.width = "1";
     cel.style.height = "1";
     cel.style.borderLeftWidth = "0px";
     cel.style.borderRightWidth = "0px";
   ...
   function MenuButton(text, x, y, w, tata, exe){
    ...
    scrie(aux, "<table border=0 cellspacing=0 cellpadding=0 width="+w+" class=item><tr><td colspan=3 bgcolor="+parentWindow.menuFgColor+" height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr><tr><td bgcolor="+parentWindow.menuFgColor+" height=100% width=1 class=item><img src=/ccrc/images/nimic.gif width=1></td><td width=100% align=center class=item oncontextmenu='return false;' onselectstart='return false;'>"+text+"</td><td bgcolor="+parentWindow.menuBgColor+" width=1 height=1 class=item><img src=/ccrc/images/nimic.gif width=1 height=1></td></tr><tr><td colspan=3 bgcolor="+parentWindow.menuBgColor+" height=1 class=item><img src=/ccrc/images/nimic.gif height=1></td></tr></table>");
